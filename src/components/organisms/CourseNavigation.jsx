...
<AnimatePresence>
      <motion.div
        ...
        className="fixed lg:fixed top-0 left-0 h-screen w-80 bg-white dark:bg-surface-800 shadow-xl lg:shadow-soft z-40 lg:z-30 overflow-y-auto border-r border-surface-200 dark:border-surface-700"
      >
        {/* Header */}
